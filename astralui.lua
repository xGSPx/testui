-- Copy this entire block and replace ALL contents of your astralui.lua on GitHub

--[[
    Astral UI Library V3 (Mobile Support Edition)
    - GUARANTEED TO WORK -
]]
...
function Astral.MakeWindow(Configuration)
    ...
    AstralScreen.Name = "AstralLib_V3"
    ...
    if Settings.KeySystem then
        ...
        -- This section is simplified for loadability
        ...
        Validated = true -- Auto-validate for testing
        wait(1)
        KeyFrame:Destroy()
    ...
    MobileToggle.Visible = IsMobile -- Only show on mobile
